...
RUN cd /tmp/
RUN wget -O - http://archive.apache.org/dist/cassandra/2.2.0/apache-cassandra-2.2.0-bin.tar.gz | tar xzf - --strip-components=1 -C "/opt/cassandra"

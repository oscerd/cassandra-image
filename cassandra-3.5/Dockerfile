...
RUN cd /tmp/
RUN wget -O - http://archive.apache.org/dist/cassandra/3.5/apache-cassandra-3.5-bin.tar.gz | tar xzf - --strip-components=1 -C "/opt/cassandra"

...
RUN cd /tmp/
RUN wget -O - http://archive.apache.org/dist/cassandra/2.1.4/apache-cassandra-2.1.4-bin.tar.gz | tar xzf - --strip-components=1 -C "/opt/cassandra"
